"""Orbit Wars v21_lite - v20 lineage + compact NeuralVal (64→32→1). Regenerate weights with tools/distill_to_numpy_v21.py after RL.
...
class Snapshot:
    ...
    def _reserve(self, p: Planet) -> int:
        ...
        # FFA: stationary enemy arc — ``net_threat`` may stay 0; still hoard ON this
        # world so Expand/Attack cannot peel it toward distant neutrals every turn.
    ...
    def plan(snap: Snapshot) -> Plan:
        ...
        if state.is_ffa_mode() and state.en_pl:
            ...
            for p in state.my_pl:
                ...
                # Softer gates: orbital separation can drift past a tight surplus gap.
