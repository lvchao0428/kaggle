"""Orbit Wars v22_lite - v20 lineage + NeuralVal (64→32→1). Weights: vec_orbit critic + bridge encoder → tools/distill_vec_bridge_v22.py (see vec_orbit/PIPELINE.md v22).
